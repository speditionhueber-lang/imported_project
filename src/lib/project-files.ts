// This file contains a list of project files to be included in the ZIP download.
// Add more files to this array to include them in the download.
...
`,
  ...
  "scripts": {
    ...
    "seed:admin": "ts-node admin.seed.ts",
    "seed:customers": "ts-node customers.seed.ts",
    "seed:employees": "ts-node employees.seed.ts",
